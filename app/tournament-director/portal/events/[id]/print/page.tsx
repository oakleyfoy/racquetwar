...
export default async function EventAuthorizationPrintPage({
  params,
}: {
    ...
    <main className="ctd-main ctd-print">
      <div className="ctd-card" style={{ marginTop: 24 }}>
        ...
        <p className="ctd-notice">
          Only this Authorized record constitutes written event authorization.
          Approved — Authorization Pending does not permit marketing or operation.
        </p>
        <PrintButton />
      </div>
    </main>
